...
- A shadow-only structure-quality layer records whether chop, trend maturity, directional conflict or limited room would have rejected each candidate. Its results are visible in research logs and performance reports but do not alter paper trades.
